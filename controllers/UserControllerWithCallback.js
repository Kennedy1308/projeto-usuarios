class UserController {
    ...
    getPhoto(callback){ //por nao ser possivel ter um return, criado uma funcao callback
        ...
        fileReader.onload = ()=>{ //callback - quando terminar de carregar a imagem, executa a funcao a seguir
            ...
            callback(fileReader.result); //fileReader.result - apresenta o conteudo do arquivo, ou seja a img (como URL base64)
        };
